...
const moviesCatergories = [];
const categoriesNoRepeat = [];

for (let movie of movies){
    moviesCatergories.push(movie.categories);
};
const moviesCatergoriesFlat = moviesCatergories.flat();

for (category of moviesCatergoriesFlat){
